...
def insert_shipping_data_0(cursor):
    ...
    file_path = os.path.join(script_dir, 'data', 'shipping_data_0.csv')
...
def insert_shipping_data_2(cursor):
    script_dir = os.path.dirname(__file__)
    file_path_1 = os.path.join(script_dir, 'data', 'shipping_data_1.csv')
    file_path_2 = os.path.join(script_dir, 'data', 'shipping_data_2.csv')
